...
/**
 * Database of type HashMap as HashMap is iterable with speed O(1). Creates a
 * map database of parameters Language, Map Integer, LanguageEntry
 * 
 * 
...
public class Database {
	...
	/**
	 * adds a kmer to the db
	 * 
	 * @param s    the kmer unhashed
	 * @param lang Language of kmer
	 */
	...
	/**
	 * sets a maximum size for each language
	 * 
