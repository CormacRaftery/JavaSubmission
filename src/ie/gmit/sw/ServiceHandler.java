...
public class ServiceHandler extends HttpServlet {
	...
	private File f;
	// =====================================================================================================================
	private Map<String, Language> outQueue = new ConcurrentSkipListMap<>();// concurrentSkipListMap works with multiple
																			// threads and orders the threads
	// =====================================================================================================================
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (taskNumber == null) {
			...
			// Add job to in-queue
			// =====================================================================================================================
			// inQueue.addFirst(new Request(option,taskNumber,s));//add params
		} else {
			// Check out-queue for finished job
			// =====================================================================================================================
			if (((Map<String, Language>) out).containsKey(taskNumber)) {
				// =====================================================================================================================
			...
			out.print("<OL>");
			// out.print("<LI>Create some type of an object from the request variables and
			// jobNumber.");// FIX REQUEST
			// out.print("<LI>Add the message request object to a LinkedList or
			// BlockingQueue (the IN-queue)");//FIX REQUEST
			out.print(
